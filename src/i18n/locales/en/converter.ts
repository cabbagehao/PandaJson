export const converter = {
  ...
  description: 'Convert JSON to YAML, XML, CSV and vice versa with our free online converter. Transform data between formats instantly while preserving structure and data types.',
