export const diff = {
  ...
  description: 'Compare two JSON files side-by-side and highlight differences with visual color-coding. Find additions, deletions, and modifications quickly with our free JSON diff comparison tool.',
