export const validator = {
  ...
  description: 'Valide instantaneamente sintaxe e estrutura de dados JSON com feedback detalhado de erros. Encontre erros de parsing JSON, problemas de sintaxe e corrija-os rapidamente com nossa ferramenta gratuita online de validação JSON.',
