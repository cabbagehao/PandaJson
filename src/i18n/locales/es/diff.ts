export const diff = {
  ...
  description: 'Compare dos archivos JSON lado a lado y resalte diferencias con codificación visual por colores. Encuentre adiciones, eliminaciones y modificaciones rápidamente con nuestra herramienta gratuita de comparación JSON.',
