export const schemaValidator = {
  ...
  description: 'Valide datos JSON contra especificaciones de esquema en línea. Verifique la integridad de la estructura de datos, tipos de campo y restricciones con nuestra herramienta gratuita de validación de esquema JSON.',
