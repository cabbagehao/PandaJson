export const treeEditor = {
  ...
  description: 'Komplexe JSON-Daten mit einer interaktiven Baumansicht bearbeiten. Verschachtelte JSON-Strukturen einfach visualisieren, modifizieren und navigieren mit unserem kostenlosen visuellen JSON-Baumeditor-Tool.',
